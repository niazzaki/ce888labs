...
![scaterplot](./CurrentFleetScatterPlot.png?raw=true)
![scaterplot](./NewFleetScatterPlot.png?raw=true)
...
- the standard deviation for the current fleet is 6.402 and new fleet 6.069. The SDVs are pretty comparable.
the figures show that current fleet is slightly widely dispersed than new fleets. However, the count of current fleet is
more than the new fleet and probably if the numbers were equal we could better compare.in the meantime, the average of
MPG for current fleet is 20.1 while for new one is 30.6. The average for current is better than the new ones, therefore,
the recommendation for the firm is not to replace its current fleet the new fleet.


~~~markdown

![logo](./bootstrap_confidence-CurrentFleet.png?raw=true)
![logo](./bootstrap_confidence-NewFleet.png?raw=true)
![logo](./CurrentFleetScatterPlot.png?raw=true)
![logo](./NewFleetScatterPlot.png?raw=true)
