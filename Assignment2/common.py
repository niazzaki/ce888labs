...
"""
This is the source file that was edited with sample code to create datasets.
"""
...
# Define t to auto-number the images

t = 0

def play_one_episode(env, func, render=False):
    """
    The function was edited with sample code given as part of assignment one to generate datasets.
    the current code saves images from breakout game to its respective folder data/breakout/images
    ...
    while True:
        ...
        # embedded sypros sample code to capture images
        ...
        if t<= 3000:
            im.save("data/breakout/images/breakout-" + str(t) + ".png")
            print("breakout- " + str(t))
            t += 1
